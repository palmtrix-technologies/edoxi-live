...
// tranform issue fix
let globalcontainer = document.querySelectorAll('.container')
let i;
for(i=0;i<modalopen.length;i++){
modalopen[i].addEventListener('click', function(){
this.nextElementSibling.querySelector('.modal-window').classList.toggle('show-modal');
document.body.classList.toggle('modal-overflow-hide');
...
modalwindow[i].classList.remove('show-modal');
document.body.classList.remove('modal-overflow-hide');
}
});
}
...
if(Boolean(search_input1)) { // This Boolean is important. Its Removes console error if the element is not in other the pages
...
document.getElementById("autocomplete-results1").addEventListener("click", function(e) {
...
var results2, courses_show1 = [];
var autocomplete_results2 = document.getElementById("autocomplete-results2");  


// events

if(Boolean(search_input2)) { // This Boolean is important. Its Removes console error if the element is not in other the pages
...
// Get the element, add a click listener...
document.getElementById("autocomplete-results2").addEventListener("click", function(e) {
    // e.target is the clicked element!
    // If it was a list item
    if (e.target && e.target.nodeName == "LI") {
      // List item found!  Output the value!
...
var results3, courses_show1 = [];
var autocomplete_results3 = document.getElementById("autocomplete-results3");  


// events

if(Boolean(search_input3)) { // This Boolean is important. Its Removes console error if the element is not in other the pages
...
// Get the element, add a click listener...
document.getElementById("autocomplete-results3").addEventListener("click", function(e) {
    // e.target is the clicked element!
    // If it was a list item
    if (e.target && e.target.nodeName == "LI") {
      // List item found!  Output the value!
