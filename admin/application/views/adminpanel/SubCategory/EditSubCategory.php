            ...
            <div class="card-body">
               ...
               <div class="col-md-4 form-group">
                                <div class="form-group">
                                    ...
                                    <div id="selectedcatss" class="hidden"><?php echo json_encode($selectedcategory); ?></div>
                                    
                                   <select class="form-control select2" id="catselectid" multiple="multiple" style="width: 100%;">
                  ...
                  <div class="col-md-4 form-group">
                     ...
                     <input id="txt_cate_name" class="form-control" value="<?= $Categorydata->subcategory_name;?>" />
                     <input id="hdn_catid" type="hidden" value="<?= $Categorydata->subcategory_id;?>" />
                  </div>
                  <div class="col-md-4 form-group">
                     <label>Slug</label>
                     <input id="txt_slug" class="form-control" value="<?= $Categorydata->subcategory_slug;?>" />
                  </div>
                  <div class="col-md-6">
                     <div class="col-md-12 no-padding form-group">
                        <label>Seo Tittle</label>
                        <input id="txt_seotittle" class="form-control" value="<?= $Categorydata->subcategory_seo_title;?>" />
                     </div>
                     <div class="col-md-12 no-padding form-group">
                        <label>Meta Keywords</label>
                        <input id="txt_metakeyword" class="form-control" value="<?= $Categorydata->subcategory_meta_keywords;?>" />
                     </div>
                  </div>
                  <div class="col-md-6 form-group">
                     <label>Meta Description <span id="charNum"></span></label>
                     <textarea id="txtMetadesctiption"  class="form-control customcontrol" onkeyup="countChar(this)"> <?= $Categorydata->subcategory_meta_description;?></textarea>
                  </div>
               </div>
...
<script src="<?= base_url() ?>assets/userscripts/SubCategory/editsubcategory.js"></script>