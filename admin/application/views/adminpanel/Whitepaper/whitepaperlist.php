              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  ...
                  foreach($whitepapers as $key=>$whitepaper)
                  {
                    ?>
                <tr>
                  <td><?=$whitepaper->Whitepaper_name;?></td>
                  <td><?=$whitepaper->slug;?></td>
                  <td><?=$whitepaper->seo_tittle;?></td>
...
<td><ul class="nav"><li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url()."edit-whitepaper/".$whitepaper->ci_witepaperID;?>">Edit</a></li>
