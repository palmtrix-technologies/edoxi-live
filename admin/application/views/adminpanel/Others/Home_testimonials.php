...
<div class="content-wrapper">
   ...
   <section class="content">
      <div class="container-fluid">
         ...
         <div class="card">
              ...
              <div class="card-body">
                ...
                <tr>
                  ...
                  <td><a href="home-testimonials/add/<?=$data->testimonial_id;?>">add</a></td>
         ...
         <div class="card-header">
                <h3 class="card-title">Home Testimonials</h3>
            ...
            <div class="card-body">
               ...
               <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="font-size:10px;" id="review"><?=$data->testimonial_review;?></td>
                  <td><?=$data->testimonial_sourse;?></td>
                   <td><a href="home-testimonials/delete/<?=$data->testimonial_id;?>">Remove</a></td>
