...
<div class="content-wrapper">
         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Couse Testimonials</li>
               </ol>
            </div>
         </div>
      </div>
   ...
   <section class="content">
      <div class="container-fluid">
         ...
         <div class="card">
              ...
              <div class="card-body">
                ...
                <tr>
                  ...
                  <td><a href="course-testimonials/add/<?=$data->testimonial_id;?>">add</a></td>
         ...
         <div class="card-header">
                <h3 class="card-title">Course Testimonials</h3>
            ...
            <div class="card-body">
               ...
               <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="font-size:10px;" id="review"><?=$data->testimonial_review;?></td>
                  <td><?=$data->testimonial_sourse;?></td>
                   <td><a href="course-testimonials/delete/<?=$data->testimonial_id;?>">Remove</a></td>
