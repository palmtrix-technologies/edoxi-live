...
<div class="content-wrapper">
            ...
            <div class="card-body">
               ...
               <div class="col-md-6 form-group hidden">
                  ...
                  <div class="col-md-6 form-group">
                     ...
                     <input id="txt_course_name" class="form-control" value="" />
                  </div>
                  <div class="col-md-6 form-group">
                     <label>Slug</label>
                  ...
                  <div class="col-md-8 form-group">
                     ...
                     <textarea id="txtMetadesctiption"  class="form-control customcontrol" ></textarea>
                  </div>
               </div>
 ...
 <?php
               ...
               <div class="row">
                ...
                <input id="txt_coursetittle" type="text" class="form-control" value="" />
                </div>
                <div class="col-md-4 form-group">
                <label>Caption</label>
                <input id="txt_courseCaption" type="text" class="form-control" value="" />
                </div>
                <div class="col-md-4 form-group">
                <label>Course Duaration</label>
                <input id="txt_courseduration" type="text" class="form-control" value="" />
                </div>

                <div class="col-md-4 form-group">
                <label>Course Location</label>
                <input id="txt_courseLocation" type="text" class="form-control" value="" />
                </div>
    ...
    <textarea class="tynimce" id="section1"></textarea></div>
                     </div>
                  </div>
               </div>
               <div class="row">
...
<script src="<?= base_url() ?>assets/userscripts/Course/addcourse.js"></script>