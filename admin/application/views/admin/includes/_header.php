...
<head>
  ...
  <title>Edoxi-training institute - admin application</title>
...
<link rel="stylesheet"  rel="stylesheet" href="https://cdn.datatables.net/1.10.23/css/jquery.dataTables.min.css"/>
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block hidden">
        <a href="<?= base_url() ?>" class="nav-link"><?= trans('home') ?></a>
      </li>
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3 hiiden">
