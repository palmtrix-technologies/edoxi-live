...
//testing purpose  schema checker
   ...
   public function schemachecker1()
   {
    $dataval=$this->mainmodel->Getslugdetails("autocad-2d-training-course-in-dubai");  
   ...
   public function schemachecker2()
   {
    $dataval=$this->mainmodel->Getslugdetails("3ds-max-training-course-in-dubai");  
    ...
    $data['dummydate']=$this->mainmodel->getdummy_date();
    $data['temp']=3;
    $data["Testimonials"] = $this->mainmodel->get_coursetestimonial_byid($id);
