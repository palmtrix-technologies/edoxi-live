                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="background:white;">
                                                ...
                                                <td style='color:black;'><?php echo $post->course_institute;?></td>
                                                <td style='color:black;'><?php echo $post->course_name;?></td>
                                                <td style='color:black;'><?php echo $post->course_added_date;?></td>
                                                <!--<td></td>-->
                                                 <td> <a href="<?php echo base_url();?>admin/home/course_edit/<?php echo $post->course_id;?>"><img src="<?php echo base_url(); ?>assets/images/pencil.png"></a>
                                                                    <a data-toggle="modal" href="#Delete_Log" class="delete_option " data-id="<?php echo $post->course_id;?>"><img src="<?php echo base_url(); ?>assets/images/delete.png"></a></td>
                                            </tr>
                                            <?php
                                            }
                                            }
