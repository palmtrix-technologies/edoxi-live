...
<body class="fix-header fix-sidebar">
    ...
    <?php include('header.php');?>
        ...
        <?php endif; ?>
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">View Lead Manager</h4>
                           <!--      <h6 class="card-subtitle">Export data to Copy, CSV, Excel, PDF & Print</h6> -->
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            if (isset($all_manager)) {
                                            $i=0;
                                            foreach($all_manager as $post){
                                            $i++;
                                            if($post->manager_status=='0')
                                            {
                                                $status_type="success";
                                                $status_state="checked";
                                            }
                                            elseif($post->manager_status=='1')
                                            {
                                                $status_type="info";
                                                $status_state="";
                                            }
                                            ...
                                            <tr style="background:white;">
                                                ...
                                                <td style='color:black;'><?php echo $post->manager_institute;?></td>
                                                <td style='color:black;'><?php echo $post->manager_name;?></td>
                                                <td style='color:black;'><?php echo $post->manager_added_date;?></td>
                                                <!--<td></td>-->
                                                 <td> <a href="<?php echo base_url();?>admin/home/manager_edit/<?php echo $post->manager_id;?>"><img src="<?php echo base_url(); ?>assets/images/pencil.png"></a>
                                                                    <a data-toggle="modal" href="#Delete_Log" class="delete_option " data-id="<?php echo $post->manager_id;?>"><img src="<?php echo base_url(); ?>assets/images/delete.png"></a></td>
                                            </tr>
                                            <?php
                                            }
                                            }
  ...
  <div class="modal-dialog" style="z-index: 10000 !important;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Delete Manager</span> ?</h4>
      </div>
      <div class="modal-body">
        Do you want to delete selected Manager ?<br/>
        This Process cannot be Rolled Back
      </div>
        <form name="frm_delete_sale" id="frm_delete_sale" action="<?php echo base_url(); ?>admin/home/manager_delete/" method="POST">
          <input type="hidden" name="manager_id" id="manager_id" value=""/>
          <div class="modal-footer">
            <button type="submit" name="btn_delete_manager" id="btn_delete_manager" value="Delete" class="btn btn-danger btn-flat">Delete</button>
