                    ...
                    <div class="col-lg-6" style="margin-left: 250px;">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white" style="text-align:  center;">Update Lead Manager</h4>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo site_url('admin/home/manager_update'); ?>" method="post">
                                    <div class="form-body">
                                        <!-- <h3 class="card-title m-t-15">Person Info</h3> -->
                                        <hr>
                                        <div class="row p-t-20">
                                              <div class="col-md-6">
                                                <input type="hidden" name="manager_id" value="<?php echo $single_manager[0]->manager_id;?>">
                                               <div class="form-group has-success">
                                                    <label class="control-label">Institute</label>
                                                       <select class="form-control custom-select" name="manager_institute">
                                                        <option>Select your Institute</option>
                                                        <option value="<?php echo $single_manager[0]->manager_institute;?>" selected><?php echo $single_manager[0]->manager_institute;?></option>
                                              ...
                                              <div class="col-md-6">
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <input type="text" id="Name" name="manager_name" class="form-control" value="<?php echo $single_manager[0]->manager_name;?>" placeholder="Enter manager name ">
