        ...
        <?php endif; ?>
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white" style="text-align:  center;">Add Lead Manager</h4>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo site_url('admin/home/manager_add'); ?>" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                              <div class="col-md-6">
                                               <div class="form-group has-success">
                                                    <label class="control-label">Institute</label>
                                                       <select class="form-control custom-select" name="manager_institute" required>
                                              ...
                                              <div class="col-md-6">
                                                <div class="form-group has-success">
                                                    ...
                                                    <input type="text" id="managername" name="manager_name" class="form-control" placeholder="Enter manager name" required>
